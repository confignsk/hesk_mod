...
<?php
include HESK_PATH . "admin.menu.php";
TlmClass::Debug($aMenuLinks, "MENU");
TlmClass::Debug(TlmClass::Server("DOCUMENT_ROOT"), "SERVER");
//$GLOBALS["TLMDEBUG"] = "111";
?>
<main class="main">
    <!-- begin header -->
    <header class="header">
        <div class="header__left">
            <?= TlmClass::ViewMenu($aMenuLinks); ?>
        </div>
